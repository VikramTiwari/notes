---
title: "💀 Acqui-killing & Corporate Neutralization"
description: "Getting acquired by a giant corporation is often the death sentence for the software product itself, which is neutralized to protect the parent company's ecosystem."
date: 2026-06-15
---
# 💀 Acqui-killing & Corporate Neutralization
...
## Skiff (YC W20)
* **What they built**: A pure software, end-to-end encrypted workspace (Mail, Drive, Docs) targeting privacy-conscious users who wanted to leave Google Workspace.
* **The Failure**: The software was excellent and beloved by its users. However, building a consumer email and storage platform is incredibly expensive due to server costs, and it is notoriously difficult to monetize. In early 2024, they were acquired by Notion. The failure here wasn't the code; it was the reality of corporate acquisitions. Notion didn't want to run a standalone, encrypted email service—they just wanted Skiff's underlying technology and engineering team to build out Notion's own document features.
* **The Outcome**: Notion completely shut down Skiff's software just six months after the acquisition. It caused massive outrage, forcing millions of privacy-conscious users to scramble for email alternatives and proving that relying on a VC-backed startup for critical daily infrastructure is a massive risk.
---
...
## Cue / Greplin (YC W10)
* **What they built**: Originally launched as Greplin, it was a pure software personal search engine. It indexed your entire digital life—Facebook, Gmail, Twitter, LinkedIn, Dropbox—so you could search across all your scattered digital accounts from one unified dashboard.
* **The Failure**: Cue built a brilliant predictive algorithm, but they ran into the classic problem of building a third-party app that fundamentally belongs at the operating system level. Apple realized that Cue's cross-platform data-indexing technology was exactly what they needed to make Siri and iOS Spotlight search actually useful.
* **The Outcome**: Apple acquired Cue in 2013 for an estimated &#36;40 million to &#36;60 million. Apple had absolutely zero interest in maintaining a standalone third-party web app; they bought the company strictly to strip-mine the engineering talent and the underlying search code. Cue was shut down immediately upon acquisition, leaving its premium subscribers completely in the dark.
