...
## Lago v1 (YC S21)
* **What they built**: The founders originally got into YC by pitching a pure software "no-code Reverse ETL" tool. The goal was to allow non-technical growth marketers to extract customer data directly from a company's data warehouse without needing to write SQL or wait on data engineers. GitHub
